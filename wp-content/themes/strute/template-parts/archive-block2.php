...
$context = array( 'style' => 'block2', 'counter' => $archive_postcounter );
?>

<article <?php hoot_attr( 'post', $context, 'archive-block archive-block2 hcolumn-1-2' ); ?>>
	...
	<div class="entry-grid hgrid">
		...
		<?php $img_size = apply_filters( 'strute_archive_imgsize', 'hoot-large-thumb', 'block2' );
