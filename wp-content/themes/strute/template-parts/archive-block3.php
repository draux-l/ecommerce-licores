...
$context = array( 'style' => 'block3', 'counter' => $archive_postcounter );
?>

<article <?php hoot_attr( 'post', $context, 'archive-block archive-block3 hcolumn-1-3' ); ?>>
	...
	<div class="entry-grid hgrid">
		...
		<?php $img_size = apply_filters( 'strute_archive_imgsize', 'hoot-medium-thumb', 'block3' );
