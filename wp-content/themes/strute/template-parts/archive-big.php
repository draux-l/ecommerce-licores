...
$context = array( 'style' => 'big', 'counter' => $archive_postcounter );
?>

<article <?php hoot_attr( 'post', $context, 'archive-big' ); ?>>
	...
	<div class="entry-grid hgrid">
		...
		<?php $img_size = apply_filters( 'strute_archive_imgsize', '', 'big' );
