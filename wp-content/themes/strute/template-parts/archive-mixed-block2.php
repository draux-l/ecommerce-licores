...
$context = array( 'style' => 'mixed-block2', 'counter' => $archive_postcounter );

if ( $archive_postcounter == 1 ) :
?>

<article <?php hoot_attr( 'post', $context, 'archive-mixed archive-mixed-block2 mixedunit-big' ); ?>>
...
<article <?php hoot_attr( 'post', $context, 'archive-mixed archive-mixed-block2 mixedunit-block2 hcolumn-1-2' ); ?>>
	...
	<div class="entry-grid hgrid">
		...
		<?php $img_size = apply_filters( 'strute_archive_imgsize', 'hoot-large-thumb', 'mixedblock2' );
		hoot_post_thumbnail( 'entry-content-featured-img entry-grid-featured-img', $img_size, true, esc_url( get_permalink() ) ); ?>
