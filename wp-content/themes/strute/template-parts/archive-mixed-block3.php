...
$archive_postcounter = hoot_data( 'archive_postcounter' );
$context = array( 'style' => 'mixed-block3', 'counter' => $archive_postcounter );

if ( $archive_postcounter == 1 ) :
?>

<article <?php hoot_attr( 'post', $context, 'archive-mixed archive-mixed-block3 mixedunit-big' ); ?>>

	<div class="entry-grid hgrid">

		<?php if ( is_sticky() ) : ?>
			<div class="entry-sticky-tag invert-typo"><?php esc_html_e( 'Sticky', 'strute' ) ?></div>
		<?php endif; ?>

		<?php $img_size = apply_filters( 'strute_archive_imgsize', '', 'mixedbig' );
...
<article <?php hoot_attr( 'post', $context, 'archive-mixed archive-mixed-block3 mixedunit-block3 hcolumn-1-3' ); ?>>
	...
	<div class="entry-grid hgrid">
		...
		<?php $img_size = apply_filters( 'strute_archive_imgsize', 'hoot-large-thumb', 'mixedblock3' );
		hoot_post_thumbnail( 'entry-content-featured-img entry-grid-featured-img', $img_size, true, esc_url( get_permalink() ) ); ?>
