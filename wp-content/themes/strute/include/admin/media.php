...
add_filter( 'hoot_custom_image_sizes', 'strute_custom_image_sizes', 5 );
 ...
 * @return array
 */
function strute_custom_image_sizes( $sizes ) {
	$sizes = array(
		...
		'hoot-medium-thumb' => array(
			'label'          => __( 'Medium Thumbnail', 'strute' ),
			'width'          => 460,
			'height'         => 400,
			'crop'           => true,
		...
		'hoot-preview-thumb' => array(
			'label'          => __( 'Preview Thumbnail', 'strute' ),
			'width'          => 465,
			'height'         => 550,
			'crop'           => true,
			'show_in_editor' => false,
		...
		'hoot-large-thumb' => array(
			'label'          => __( 'Large Thumbnail', 'strute' ),
			'width'          => 690,
			'height'         => 550,
			'crop'           => true,
			'show_in_editor' => false,
