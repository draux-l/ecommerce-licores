...
strute_add_custom_title_content( 'pre', 'page.php' );
if ( strute_titlearea_top() ) {
	strute_pagehead_img( 'page', false );
	get_template_part( 'template-parts/loop-meta' ); // Loads the template-parts/loop-meta.php template to display Title Area with Meta Info (of the loop)
	strute_add_custom_title_content( 'post', 'page.php' );
} else {
	strute_pagehead_img( 'page', true );
}

// Template modification Hook
do_action( 'strute_before_content_grid', 'page.php' );
?>
...
<div class="hgrid main-content-grid">
	...
	<main <?php hoot_attr( 'content' ); ?>>
		<div <?php hoot_attr( 'content-wrap', 'page' ); ?>>
			...
			<?php
			// Template modification Hook
			do_action( 'strute_main_start', 'page.php' );
			...
			if ( have_posts() ) :
				...
				// Template modification Hook
				do_action( 'strute_loop_start', 'page.php' );

				// Display Featured Image if present
				if ( strute_featured_image_location('page') === 'content' ) {
					$img_size = apply_filters( 'strute_page_imgsize', '', 'content' );
				...
				// Template modification Hook
				do_action( 'strute_loop_end', 'page.php' );

				// Template modification Hook
				do_action( 'strute_after_content_wrap', 'page.php' );
			...
			// Template modification Hook
			do_action( 'strute_main_end', 'page.php' );
			?>
