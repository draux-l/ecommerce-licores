...
if ( !function_exists( 'hoot_themefonts' ) ):
function hoot_themefonts( $return ) {
	static $list = array();
	if ( empty( $list ) ) {
		$list = apply_filters( 'hoot_themefonts', array(
			'fontns' => array(
				esc_html__( 'Standard Font 1 (Noto Sans)', 'strute'),
				'"Noto Sans", sans-serif',
				'Noto Sans',
				array(
					'normal' => array( '300','400','600','700' ),
					'italic' => array( '300','400','600','700' ),
				),
			),
			'fontos' => array(
				esc_html__( 'Standard Font 2 (Open Sans)', 'strute'),
			...
			'fontlt' => array(
				esc_html__( 'Standard Font 3 (Lato)', 'strute'),
				'"Lato", sans-serif',
				'Lato',
				array(
					'normal' => array( '300','400','700' ),
					'italic' => array( '300','400','700' ),
				),
			),
			'fontro' => array(
				esc_html__( 'Standard Font 4 (Roboto)', 'strute'),
				'"Roboto", sans-serif',
				'Roboto',
				array(
					'normal' => array( '300','400','600','700' ),
			...
			'fontpo' => array(
				esc_html__( 'Standard Font 5 (Poppins)', 'strute'),
				'"Poppins", sans-serif',
				'Poppins',
				array(
					'normal' => array( '300','400','600','700' ),
			...
			'fontcf' => array(
				esc_html__( 'Standard Font 6 (Comfortaa)', 'strute'),
			...
			'fontpt' => array(
				esc_html__( 'Heading 1 (PT Serif)', 'strute'),
				'"PT Serif", serif',
				'PT Serif',
				array(
			...
			'fontsl' => array(
				esc_html__( 'Heading 2 (Slabo)', 'strute'),
				'"Slabo 27px", serif',
				'Slabo 27px',
				array(
					'normal' => array( '400' ),
			...
			'fontgr' => array(
				esc_html__( 'Heading 3 (Georgia)', 'strute'),
				'Georgia, serif',
				'Georgia',
			),
			'fontlo' => array(
				esc_html__( 'Cursive Font 1 (Lobster)', 'strute'),
				'"Lobster Two", cursive, sans-serif',
				'Lobster Two',
				array(
					'normal' => array( '400','700' ),
					'italic' => array( '400','700' ),
			...
			'fontcg' => array(
				esc_html__( 'Cursive Font 2 (Courgette)', 'strute'),
				'"Courgette", cursive, sans-serif',
				'Courgette',
				array(
					'normal' => array( '400' ),
				),
			...
			'fontds' => array(
				esc_html__( 'Cursive Font 3 (Dancing Script)', 'strute'),
				'"Dancing Script", cursive, sans-serif',
				'Dancing Script',
				array(
					'normal' => array( '400','600','700' ),
				),
			),
			'fontct' => array(
				esc_html__( 'Cursive Font 4 (Caveat)', 'strute'),
			...
			'fontkl' => array(
				esc_html__( 'Cursive Font 5 (Kalam)', 'strute'),
			...
			'fontfg' => array(
				esc_html__( 'Cursive Font 6 (Fugaz One)', 'strute'),
				'"Fugaz One", cursive, sans-serif',
				'Fugaz One',
				array(
					'normal' => array( '400' ),
				),
			...
			'fontow' => array(
				esc_html__( 'Display 1 (Oswald)', 'strute'),
				'"Oswald", sans-serif',
				'Oswald',
				array(
					'normal' => array( '300','400','600','700' ),
			...
			'fontbo' => array(
				esc_html__( 'Display 2 (Bokor)', 'strute'),
				'"Bokor", sans-serif',
				'Bokor',
				array(
					'normal' => array( '400' ),
			...
			'fontcd' => array(
				esc_html__( 'Display 3 (Caesar Dressing)', 'strute'),
	...
	if ( $return === 'options' ) {
		return array_map( function( $v ) { return $v[0]; }, $list );
	} elseif ( $return === 'optionsmap' ) {
		return array_map( function( $v ) { return $v[1]; }, $list );
	} elseif ( $return === 'enum' ) {
		$enum = array();
		...
		return $enum;
	} elseif ( $return === 'enqueue' ) {
		$enqueue = array();
		foreach ( $list as $nick => $font ) {
			if ( !empty( $font[3] ) ) $enqueue[ $nick ] = array( $font[2] => $font[3] ); // only add if google font
		}
		return $enqueue;
	}
	return $list;
...
function hoot_enum_font_faces( $return = '' ) {
	...
	$themefonts = empty( $googlefonts ) ? hoot_themefonts('enum') : array();
	...
	elseif ( $return == 'google-fonts' || $return == 'google-font' )
		...
		$fonts = array_merge( $webfonts, $googlefonts, $themefonts );
...
function hoot_enum_font_styles() {
	$default = array(
		'none'                      => __( 'None', 'strute' ),
		'italic'                    => __( 'Italic', 'strute' ),
		'bold'                      => __( 'Bold', 'strute' ),
		'bold italic'               => __( 'Bold Italic', 'strute' ),
		'semibold'                  => __( 'SemiBold', 'strute' ),
		'semibold italic'           => __( 'SemiBold Italic', 'strute' ),
		'lighter'                   => __( 'Light', 'strute' ),
		'lighter italic'            => __( 'Light Italic', 'strute' ),
		'uppercase'                 => __( 'Uppercase', 'strute' ),
		'uppercase italic'          => __( 'Uppercase Italic', 'strute' ),
		'uppercase bold'            => __( 'Uppercase Bold', 'strute' ),
		'uppercase bold italic'     => __( 'Uppercase Bold Italic', 'strute' ),
		'uppercase semibold'        => __( 'Uppercase SemiBold', 'strute' ),
		'uppercase semibold italic' => __( 'Uppercase SemiBold Italic', 'strute' ),
		'uppercase lighter'         => __( 'Uppercase Light', 'strute' ),
		'uppercase lighter italic'  => __( 'Uppercase Light Italic', 'strute' )
		);
...
function hoot_enum_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'strute' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'strute' ),
		'repeat-y'  => __( 'Repeat Vertically', 'strute' ),
		'repeat'    => __( 'Repeat All', 'strute' ),
		);
...
function hoot_enum_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'strute' ),
		'top center'    => __( 'Top Center', 'strute' ),
		'top right'     => __( 'Top Right', 'strute' ),
		'center left'   => __( 'Middle Left', 'strute' ),
		'center center' => __( 'Middle Center', 'strute' ),
		'center right'  => __( 'Middle Right', 'strute' ),
		'bottom left'   => __( 'Bottom Left', 'strute' ),
		'bottom center' => __( 'Bottom Center', 'strute' ),
		'bottom right'  => __( 'Bottom Right', 'strute')
		);
...
function hoot_enum_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'strute' ),
		'fixed'  => __( 'Fixed in Place', 'strute'),
		);
...
function hoot_enum_background_size() {
	$default = array(
		'original' => __( 'Original Size', 'strute' ),
		'contain'  => __( 'Fit to Screen', 'strute'),
		'cover'    => __( 'Fill Screen', 'strute'),
		);
...
function hoot_enum_background_type() {
	$default = array(
		'predefined' => __( 'Predefined Pattern', 'strute' ),
		'custom'     => __( 'Custom Image', 'strute' ),
		);
...
function hoot_enum_background_pattern() {
	$imgdir = hoot_data()->template_uri;
	$default = array(
		0                                       => $imgdir . 'images/patterns/0_preview.jpg',
		$imgdir . 'images/patterns/1.png'       => $imgdir . 'images/patterns/1_preview.png',
		$imgdir . 'images/patterns/2.png'       => $imgdir . 'images/patterns/2_preview.png',
		$imgdir . 'images/patterns/3.png'       => $imgdir . 'images/patterns/3_preview.png',
		$imgdir . 'images/patterns/4.png'       => $imgdir . 'images/patterns/4_preview.png',
		$imgdir . 'images/patterns/5.png'       => $imgdir . 'images/patterns/5_preview.png',
		$imgdir . 'images/patterns/6.png'       => $imgdir . 'images/patterns/6_preview.png',
		$imgdir . 'images/patterns/7.png'       => $imgdir . 'images/patterns/7_preview.png',
		$imgdir . 'images/patterns/1light.png'  => $imgdir . 'images/patterns/1light_preview.png',
		$imgdir . 'images/patterns/2light.png'  => $imgdir . 'images/patterns/2light_preview.png',
		$imgdir . 'images/patterns/3light.png'  => $imgdir . 'images/patterns/3light_preview.png',
		$imgdir . 'images/patterns/4light.png'  => $imgdir . 'images/patterns/4light_preview.png',
		$imgdir . 'images/patterns/5light.png'  => $imgdir . 'images/patterns/5light_preview.png',
		$imgdir . 'images/patterns/6light.png'  => $imgdir . 'images/patterns/6light_preview.png',
		$imgdir . 'images/patterns/7light.png'  => $imgdir . 'images/patterns/7light_preview.png',
	);
	if ( apply_filters( 'hoot_enum_background_extrapatterns', true ) ) {
		$default[ $imgdir . 'images/patterns/07200.jpg' ] = $imgdir . 'images/patterns/07200_preview.jpg';
		$default[ $imgdir . 'images/patterns/08700.jpg' ] = $imgdir . 'images/patterns/08700_preview.jpg';
		$default[ $imgdir . 'images/patterns/08900.jpg' ] = $imgdir . 'images/patterns/08900_preview.jpg';
		$default[ $imgdir . 'images/patterns/10700.jpg' ] = $imgdir . 'images/patterns/10700_preview.jpg';
	}
...
function hoot_enum_social_profiles( $skype = false, $email = true ) {
	$social = array(
		'fa-amazon'         => __( 'Amazon', 'strute' ),
		'fa-android'        => __( 'Android', 'strute' ),
		'fa-apple'          => __( 'Apple', 'strute' ),
		'fa-bandcamp'       => __( 'Bandcamp', 'strute' ),
		'fa-behance'        => __( 'Behance', 'strute' ),
		'fa-bitbucket'      => __( 'Bitbucket', 'strute' ),
		'fa-btc'            => __( 'BTC', 'strute' ),
		'fa-buysellads'     => __( 'BuySellAds', 'strute' ),
		'fa-codepen'        => __( 'Codepen', 'strute' ),
		'fa-codiepie'       => __( 'Codie Pie', 'strute' ),
		'fa-contao'         => __( 'Contao', 'strute' ),
		'fa-dashcube'       => __( 'Dash Cube', 'strute' ),
		'fa-delicious'      => __( 'Delicious', 'strute' ),
		'fa-deviantart'     => __( 'Deviantart', 'strute' ),
		'fa-digg'           => __( 'Digg', 'strute' ),
		'fa-discord'        => __( 'Discord', 'strute' ),
		'fa-dribbble'       => __( 'Dribbble', 'strute' ),
		'fa-dropbox'        => __( 'Dropbox', 'strute' ),
		'fa-eercast'        => __( 'Eercast', 'strute' ),
		'fa-envelope'       => __( 'Email', 'strute' ),
		'fa-etsy'           => __( 'Etsy', 'strute' ),
		'fa-facebook'       => __( 'Facebook', 'strute' ),
		'fa-flickr'         => __( 'Flickr', 'strute' ),
		'fa-forumbee'       => __( 'Forumbee', 'strute' ),
		'fa-foursquare'     => __( 'Foursquare', 'strute' ),
		'fa-free-code-camp' => __( 'Free Code Camp', 'strute' ),
		'fa-get-pocket'     => __( 'Pocket (getpocket)', 'strute' ),
		'fa-github'         => __( 'Github', 'strute' ),
		'fa-google'         => __( 'Google', 'strute' ),
		'fa-google-plus'    => __( 'Google Plus', 'strute' ),
		'fa-google-wallet'  => __( 'Google Wallet', 'strute' ),
		'fa-houzz'          => __( 'Houzz', 'strute' ),
		'fa-imdb'           => __( 'IMDB', 'strute' ),
		'fa-instagram'      => __( 'Instagram', 'strute' ),
		'fa-jsfiddle'       => __( 'JS Fiddle', 'strute' ),
		'fa-lastfm'         => __( 'Last FM', 'strute' ),
		'fa-leanpub'        => __( 'Leanpub', 'strute' ),
		'fa-linkedin'       => __( 'Linkedin', 'strute' ),
		'fa-meetup'         => __( 'Meetup', 'strute' ),
		'fa-mixcloud'       => __( 'Mixcloud', 'strute' ),
		'fa-patreon'        => __( 'Patreon', 'strute' ),
		'fa-paypal'         => __( 'Paypal', 'strute' ),
		'fa-pinterest'      => __( 'Pinterest', 'strute' ),
		'fa-quora'          => __( 'Quora', 'strute' ),
		'fa-reddit'         => __( 'Reddit', 'strute' ),
		'fa-rss'            => __( 'RSS', 'strute' ),
		'fa-scribd'         => __( 'Scribd', 'strute' ),
		'fa-skype'          => __( 'Skype', 'strute' ),
		'fa-slack'          => __( 'Slack', 'strute' ),
		'fa-slideshare'     => __( 'Slideshare', 'strute' ),
		'fa-snapchat'       => __( 'Snapchat', 'strute' ),
		'fa-soundcloud'     => __( 'Soundcloud', 'strute' ),
		'fa-spotify'        => __( 'Spotify', 'strute' ),
		'fa-stack-exchange' => __( 'Stack Exchange', 'strute' ),
		'fa-stack-overflow' => __( 'Stack Overflow', 'strute' ),
		'fa-steam'          => __( 'Steam', 'strute' ),
		'fa-stumbleupon'    => __( 'Stumbleupon', 'strute' ),
		'fa-tiktok'         => __( 'TikTok', 'strute' ),
		'fa-trello'         => __( 'Trello', 'strute' ),
		'fa-telegram-plane' => __( 'Telegram', 'strute' ),
		'fa-tripadvisor'    => __( 'Trip Advisor', 'strute' ),
		'fa-tumblr'         => __( 'Tumblr', 'strute' ),
		'fa-twitch'         => __( 'Twitch', 'strute' ),
		'fa-twitter'        => __( 'Twitter', 'strute' ),
		'fa-viadeo'         => __( 'Viadeo', 'strute' ),
		'fa-vimeo-square'   => __( 'Vimeo', 'strute' ),
		'fa-vk'             => __( 'VK', 'strute' ),
		'fa-whatsapp'       => __( 'Whatsapp', 'strute' ),
		'fa-wikipedia-w'    => __( 'Wikipedia', 'strute' ),
		'fa-windows'        => __( 'Windows', 'strute' ),
		'fa-wordpress'      => __( 'WordPress', 'strute' ),
		'fa-x-twitter'      => __( 'X (Twitter)', 'strute' ),
		'fa-square-x-twitter' => __( 'X (Twitter) Square', 'strute' ),
		'fa-xing'           => __( 'Xing', 'strute' ),
		'fa-y-combinator'   => __( 'Y Combinator', 'strute' ),
		'fa-yelp'           => __( 'Yelp', 'strute' ),
		'fa-youtube'        => __( 'Youtube', 'strute' ),
	);
...
function hoot_fonticons_list( $return = 'icons' ) {
	...
	if ( 'sections' == $return ) :
		return apply_filters( 'hoot_fonticons_sections', array(
			'fonticons' => __('Font Icons', 'strute'),
			'brands'    => __('Brands', 'strute'),
			)
		);
	endif;
