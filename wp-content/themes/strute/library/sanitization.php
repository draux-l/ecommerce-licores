...
/**
 * Sanitizes a json string value
 *
 * @param int|string $value
 * @return int|string
 */
if ( !function_exists( 'hoot_sanitize_jsonstring' ) ):
	function hoot_sanitize_jsonstring( $value ) {
		$testvalue = is_string( $value ) ? json_decode( $value, true ) : false;
